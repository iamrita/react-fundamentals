...
console.log({id: 'my-thing', ...props})
const element = <div {...props}/> // prints out Hello World 
// prints out {id: 'my-thing', children: 'Hello World', className: 'container'}
// Order matters, if you override children after the props, it will take the last value

const element = <div id="my-thing" className="default" {...props}/> // order matters here, default is the default value and is overriden by whatever classname is in props
